...
class CNN:
    ...
    def load(self, classifier_type):
        if classifier_type == 'Text':
            self.model_path = 'E:/ABC/Model/rico_compos/cnn-textview-2.h5'
            self.class_map = ['Text', 'Non-Text']
        elif classifier_type == 'Noise':
            self.model_path = 'E:/ABC/Model/rico_compos/cnn-noise-1.h5'
            ...
            self.model_path = 'E:/ABC/Model/rico_compos/cnn-image-1.h5'
