...
def save_corners_json(file_path, compos, new=True):
    ...
    output['compos'].append({'id': 0, 'class': 'Background',"clip_path":"REDUNDANT", 'column_min': 0, 'row_min': 0, 'column_max': img_shape[1], 'row_max': img_shape[0], 'width': img_shape[1], 'height': img_shape[0]})
    for compo in compos:
